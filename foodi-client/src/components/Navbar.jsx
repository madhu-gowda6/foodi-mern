    ...
    <>
      ...
      <li tabIndex={0}>
        <details>
          ...
          <ul className={`p-2 ${isDarkMode ? 'dark' : ''}`}>
            ...
            <li>
              <a href="/menu" className={`text-${isDarkMode ? 'dark' : ''}`}>Salad</a>
            </li>
            <li>
              <a href="/menu" className={`text-${isDarkMode ? 'dark' : 'dark'}`}>Pizza</a>
            </li>
          </ul>
        </details>
      </li>
      <li tabIndex={0}>
        <details>
          ...
          <ul className={`p-2 ${isDarkMode ? 'dark' : ''}`}>
            <li>
              <a href="/menu" className={`text-${isDarkMode ? 'text-white' : 'black'}`}>Online Order</a>
            </li>
            <li>
      ...
      <li>
        <a href="/offers" className={`text-${isDarkMode ? 'white' : 'black'}`}>Offers</a>
      </li>
    </>
  );
  return (
